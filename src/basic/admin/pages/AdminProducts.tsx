...
import { NotificationActions, Product, ProductsActions, SOLD_OUT } from "../../shared/types";
...
export const AdminProducts = ( {
  ...
  const { products, deleteProduct, updateProduct, addProduct, getProduct } = productsActions;
